...
| `Tests/ProxyE2E/main.swift` | Direct + tunneled CONNECT, half-close full body, 200-way concurrency, dead-peer (RST) reaping — live BSD sockets with mock origin + mock SOCKS5 |
